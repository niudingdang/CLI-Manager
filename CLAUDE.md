...
This project is indexed by GitNexus as **CLI-Manager** (5945 symbols, 10537 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
