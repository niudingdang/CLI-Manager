...
This project is indexed by GitNexus as **CLI-Manager** (2272 symbols, 3664 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
