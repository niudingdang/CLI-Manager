...
This project is indexed by GitNexus as **CLI-Manager** (9699 symbols, 18858 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
